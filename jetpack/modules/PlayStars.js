...
try{
    ...
    planetArc.GCParams.shadow = [0.1, 0.1, sunColor, 0];//planetArc.radius*2];
    ...
    let gStars = [];
    for(let i=0; 6>i; i++){
    let gStarColor = MHelp.randOpt("white", "crimson", "goldenrod")
    ...
    gStar.GCParams.shadow = [0.1, 0.1, gStarColor, gStar.breadthY];
        ...
        */
        ...
        gStars.map((gStar)=>{
            ...
            if(gStar.x+gStar.lengthX<0 ){    
                ...
                gStar.lengthX = 10+Math.random()*10; gStar.breadthY = 5;
                gStar.GCParams.shadow=[0.1, 0.1, gStar.color, gStar.breadthY];
