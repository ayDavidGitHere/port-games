...
try{
    ...
    let hero =
    {type:"car", obj: {}, x: CW/20, y: CH, width: CW/10, height: CH/20, linecolor: "red", maskcolor: "midnightblue"};
    hero.BRFace = new CDraw.rect(hero.x, hero.width, hero.y-hero.height, hero.height, "_"+hero.maskcolor);
    hero.BROutline = new CDraw.rect(hero.x, hero.width, hero.y-hero.height, hero.height, 1+"_"+hero.linecolor);
    hero.BRoofFace = new CDraw.arc(hero.x+hero.width/2, hero.y-hero.width, hero.width/2, 6.3, 3.2, "_green")
    
    scene.add(hero.BRoofFace);
    //scene.add(hero.BRFace);
    scene.add(hero.BROutline)
